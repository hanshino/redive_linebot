...
exports.closeGroup = (groupId) => {
    return setStatus(this.table.Guild, {
        status : 0,
...
exports.closeUser = (userId) => {
    return setStatus(this.table.User, {
        status : 0,
        closeDTM : new Date().getTime(),
    }, {
        status : 1,
...
exports.memberJoined = (userId, groupId) => {
    var query = sql.insert(this.table.GuildMembers, {guildId : groupId, userId : userId, JoinedDTM : new Date().getTime()}) ;
    return sqlite.run(query.text, query.values) ;
}
