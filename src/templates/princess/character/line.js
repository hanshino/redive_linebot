const strCharacterInfoTPL = JSON.stringify({
  type: "bubble",
  hero: {
    type: "image",
    url: "{CharacterImage}",
        ...
        contents: [
          {
            ...
            spacing: "md",
            contents: [
              { type: "text", text: "公會", color: "#aaaaaa", size: "md", flex: 1 },
              { type: "text", text: "{Guild}", wrap: true, color: "#666666", size: "md", flex: 5 },
            ],
          },
          {
            type: "box",
            ...
            contents: [
              {
                ...
                flex: 1,
                contents: [
                  { type: "text", text: "生日", color: "#aaaaaa", size: "md", flex: 1 },
                  {
                    type: "text",
                    text: "{Birthday}",
                    wrap: true,
              ...
              },
              {
                ...
                flex: 1,
                contents: [
                  { type: "text", text: "年齡", color: "#aaaaaa", size: "md", flex: 1 },
                  {
                    type: "text",
                    text: "{Age}",
                    wrap: true,
            ...
            contents: [
              {
                ...
                spacing: "md",
                contents: [
                  { type: "text", text: "身高", color: "#aaaaaa", size: "md", flex: 1 },
                  {
                    type: "text",
                    text: "{Height}",
                    wrap: true,
              ...
              },
              {
                ...
                spacing: "md",
                contents: [
                  { type: "text", text: "體重", color: "#aaaaaa", size: "md", flex: 1 },
                  {
                    type: "text",
                    text: "{Weight}",
                    wrap: true,
            ...
            contents: [
              {
                ...
                spacing: "md",
                contents: [
                  { type: "text", text: "血型", color: "#aaaaaa", size: "md", flex: 1 },
                  {
                    type: "text",
                    text: "{Blood}",
                    wrap: true,
              ...
              },
              {
                ...
                spacing: "md",
                contents: [
                  { type: "text", text: "種族", color: "#aaaaaa", size: "md", flex: 1 },
                  {
                    type: "text",
                    text: "{Class}",
                    wrap: true,
          ...
          },
          {
            ...
            spacing: "md",
            contents: [
              { type: "text", text: "喜好", color: "#aaaaaa", size: "md", flex: 1 },
              { type: "text", text: "{Habit}", wrap: true, color: "#666666", size: "md", flex: 5 },
            ],
          },
          {
            type: "box",
            ...
            spacing: "md",
            contents: [
              { type: "text", text: "聲優", color: "#aaaaaa", size: "md", flex: 1 },
              { type: "text", text: "{CV}", wrap: true, color: "#666666", size: "md", flex: 5 },
            ],
          },
        ],
      },
...
const strRowEquipRequireTPL = JSON.stringify({
  type: "box",
  layout: "horizontal",
  contents: [
    { type: "text", text: "{Rank}", weight: "bold", color: "#007bff", gravity: "center", flex: 1 },
    { type: "image", url: "{ImageOne}", size: "xxs", flex: 1, margin: "xs" },
    { type: "image", url: "{ImageTwo}", size: "xxs", flex: 1, margin: "xs" },
    { type: "image", url: "{ImageThree}", size: "xxs", flex: 1, margin: "xs" },
    { type: "image", url: "{ImageFour}", size: "xxs", flex: 1, margin: "xs" },
    { type: "image", url: "{ImageFive}", size: "xxs", flex: 1 },
    { type: "image", url: "{ImageSix}", size: "xxs", flex: 1, margin: "xs" },
  ],
});
const strEquipRequireTPL = JSON.stringify({
  type: "bubble",
  header: {
    type: "box",
    layout: "vertical",
    contents: [{ type: "text", text: "{Title}", weight: "bold", color: "#1DB446", wrap: true }],
  },
  body: { type: "box", layout: "vertical", spacing: "sm", contents: [] },
});
const strUniqueEquipTPL = JSON.stringify({
  type: "bubble",
  body: {
    type: "box",
    layout: "vertical",
    ...
    contents: [
      ...
      { type: "image", url: "{Image}", size: "md", flex: 1, margin: "lg" },
      {
        type: "box",
        layout: "vertical",
        contents: [
      ...
      },
      {
        ...
        layout: "horizontal",
        contents: [
          { type: "text", text: "屬性", size: "sm", color: "#555555", flex: 1 },
          { type: "text", text: "{Status}", size: "sm", color: "#111111", flex: 5, wrap: true },
        ],
      },
      {
        type: "box",
        layout: "horizontal",
        contents: [
          { type: "text", text: "描述", size: "sm", color: "#555555", flex: 1 },
          {
            type: "text",
            text: "{Description}",
            size: "sm",
...
const strSkillTPL = JSON.stringify({
  type: "bubble",
  body: {
    type: "box",
    layout: "vertical",
...
const strActionTPL = JSON.stringify({
  type: "bubble",
  body: {
    type: "box",
    layout: "vertical",
...
const strSkillInfoTPL = JSON.stringify({
  type: "bubble",
  body: {
    type: "box",
    layout: "vertical",
    ...
    contents: [
      ...
      },
      {
        ...
        layout: "horizontal",
        contents: [
          { type: "text", text: "類型", size: "sm", color: "#555555", flex: 1 },
          { type: "text", text: "{Type}", size: "sm", color: "#111111", flex: 5, wrap: true },
        ],
      },
      {
        type: "box",
        layout: "horizontal",
        contents: [
          { type: "text", text: "效果", size: "sm", color: "#555555", flex: 1 },
          { type: "text", text: "{Effect}", size: "sm", color: "#111111", flex: 5, wrap: true },
        ],
      },
      {
        type: "box",
...
function getRecommend({ characterData, recommendData }) {
  let cover = {
      ...
      contents: [
        {
          type: "text",
          contents: [
            { type: "span", text: "Rank推薦：" },
            { type: "span", text: "{rank}", color: "#FF4500" },
          ],
        },
        {
          type: "text",
    ...
    footer: {
      type: "box",
      layout: "vertical",
      contents: [{ type: "text", text: "by 煌靈", size: "xxs", align: "end", color: "#2e856e" }],
    },
  };
  let content = {
    type: "bubble",
    body: {
      ...
      layout: "vertical",
      contents: [
        { type: "text", text: "此次數據差異", size: "lg" },
        { type: "separator", color: "#000000", margin: "md" },
      ],
      spacing: "xs",
    },
  };
  ...
  return {
    type: "carousel",
    contents: [coverBubble, contentBubble],
  };
}
...
function _getSkillRow(objData) {
  let strTemplate = JSON.stringify({
    type: "box",
    layout: "horizontal",
    contents: [
      { type: "image", url: "{Image}", size: "xxs", flex: 1, margin: "xs" },
      {
        type: "box",
        layout: "vertical",
        flex: 3,
        contents: [
          { type: "text", text: "{Type}", weight: "bold", color: "{Color}" },
...
module.exports = {
  ...
  showCharacter: function (context, name, objData) {
    ...
    if (Object.prototype.hasOwnProperty.call(Unique, "Name") === true) {
