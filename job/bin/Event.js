...
const ChatLevelController = require("../controller/ChatLevelController");
const EventModel = require("../model/event");
const redis = require("../lib/redis");

exports.eventDequeue = eventDequeue;
exports.updateRecord = ChatLevelController.updateRecords;
...
async function eventDequeue() {
  ...
  while (processCount < 1000) {
    ...
    await Promise.all([eventHandle(botEvent), ChatLevelController.handleEvent(botEvent)]);
    processCount++;
  }
}
