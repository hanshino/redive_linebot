const BLESSINGS = [
  ...
  },
  {
    ...
    slug: "whispering",
    display_name: "絮語之心",
    effect_meta: { type: "diminish_tier_expand", tier: "0-400", to: 600 },
    description: "日 XP 100% 區間 0–400 → 0–600。",
  },
  {
    id: 5,
    slug: "rhythm_spring",
    display_name: "節律之泉",
    effect_meta: { type: "diminish_tier_expand", tier: "400-1000", to: 1200 },
    description: "日 XP 30% 區間 400–1000 → 400–1200。",
  },
  {
    id: 6,
    slug: "star_guard",
