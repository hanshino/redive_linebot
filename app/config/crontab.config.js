module.exports = [
  ...
  {
    name: "Auto Janken Matchmaking",
    description: "create and settle the daily subscription auto-janken manifest",
    period: ["0", "0", "21", "*", "*", "*"],
    immediate: false,
    enabled: true,
  ...
  {
    name: "Janken Auto Match Outbox Drainer",
    description: "deliver pending auto-janken achievement events",
    period: ["30", "*", "*", "*", "*", "*"],
    immediate: false,
    enabled: true,
    timeZone: "Asia/Taipei",
